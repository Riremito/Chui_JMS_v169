...
public enum MapleBuffStat implements Serializable, Buffstat {
    ...
    //2 unknown
    ENHANCED_WDEF(0x1/*0x40000000*/,  3),
    ENHANCED_MDEF(0x2/*0x80000000*/, 3),
    PERFECT_ARMOR(GameConstants.GMS ? 0x8 : 0x1, 3),
    ...
    //speshul
    ENERGY_CHARGE(0x4000000, 3),
    DASH_SPEED(0x8000000, 3),
    DASH_JUMP(0x10000000, 3),
    MONSTER_RIDING(0x20000000, 3/*0x10000000, 8*/),
    SPEED_INFUSION(0x40000000, 3),
    HOMING_BEACON(0x80000000, 3),
    UNDEAD(0x1, 4), //end speshulness
    ;
