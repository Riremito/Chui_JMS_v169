...
//                c.getPlayer().getMap().spawnMonsterOnGroundBelow(mob, c.getPlayer().getPosition());
                c.getPlayer().getMap().spawnMonster_sSack(mob, c.getPlayer().getPosition(), -2, c.getPlayer().getFh());
            }
            return 1;
        }
    }
...
/*    public static class ReloadIPMonitor extends CommandExecute {
    ...
    public static class DReactor extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            MapleMap map = c.getPlayer().getMap();
            List<MapleMapObject> reactors = map.getMapObjects(Arrays.asList(MapleMapObjectType.REACTOR));
