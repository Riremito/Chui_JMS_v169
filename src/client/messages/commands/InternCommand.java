...
public class InternCommand {
    ...
    public static class Hide extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            SkillFactory.getSkill(5001004/*GameConstants.GMS ? 9101004 : 9001004*/).getEffect(1).applyTo(c.getPlayer());
            return 0;
        }
    }
    ...
    public static class RemoveDrops extends CommandExecute {
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(5, "Cleared " + c.getPlayer().getMap().getItemsSize()/*getNumItems()*/ + " drops");
    ...
    public static class MobDebug extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (map == null) {
                c.getPlayer().dropMessage(0, "Map does not exist");
                return 0;
            }
            MapleMonster mob;
            for (MapleMapObject monstermo : map.getMapObjects(Arrays.asList(MapleMapObjectType.MONSTER))) {
                mob = (MapleMonster) monstermo;
                c.getPlayer().dropMessage(0, "Monster " + mob.toString());
            }
            return 1;
        }
    }
