...
//    private short fh = 0;
    ...
    public void addFatigue(MapleCharacter owner, int f) {
        ...
        owner.getClient().announce(MaplePacketCreator.updateFamiliar(this));
...
/*    public void setFh(int f) {
    ...
    public void sendSpawnData(MapleClient client) {
        client.announce(MaplePacketCreator.spawnFamiliar(this, true));
    }

    @Override
    public void sendDestroyData(MapleClient client) {
        client.announce(MaplePacketCreator.spawnFamiliar(this, false));
    }
        ...
        for (final LifeMovementFragment move : movement) {
            if (move instanceof LifeMovement) {
                if (move instanceof AbsoluteLifeMovement) {
                    setFh(((AbsoluteLifeMovement) move).getFh());
                }
            }
        }
    }
