...
public class BuddyListHandler {
    ...
    public static final void BuddyOperation(final LittleEndianAccessor slea, final MapleClient c) {
        ...
        if (mode == 1) { // add
            ...
            final String groupName = "其他"/*slea.readMapleAsciiString()*/;
            ...
            if (ble != null && (ble.getGroup().equals(groupName) || !ble.isVisible())) {
                c.announce(MaplePacketCreator.buddylistMessage((byte) 11));
	    } else if (ble != null && ble.isVisible()) {
	    	ble.setGroup(groupName);
		c.announce(MaplePacketCreator.updateBuddylist(buddylist.getBuddies(), 10));
			    ...
			    charWithId = getCharacterIdAndNameFromDatabase(addName, groupName);
                    ...
                    if (charWithId != null) {
                        ...
                        if (buddyAddResult == BuddyAddResult.BUDDYLIST_FULL) {
                            c.announce(MaplePacketCreator.buddylistMessage((byte) 12));
                        } else {
                        ...
                        c.announce(MaplePacketCreator.buddylistMessage((byte) 15));
                    }
            ...
            if (!buddylist.isFull() && ble != null && !ble.isVisible()) {
                ...
                buddylist.put(new BuddylistEntry(ble.getName(), otherCid, "其他", channel, true));
                c.announce(MaplePacketCreator.updateBuddylist(buddylist.getBuddies(), 10));
	    ...
	    final BuddylistEntry blz = buddylist.get(otherCid);
            ...
            c.announce(MaplePacketCreator.updateBuddylist(buddylist.getBuddies(), 18));
	}
    }
