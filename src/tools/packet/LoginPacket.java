...
public class LoginPacket {
    ...
    public static final byte[] getHello(final short mapleVersion, final byte[] sendIv, final byte[] recvIv) {
        ...
        mplew.write(recvIv);
        mplew.write(sendIv);
        mplew.write(3); // 1 = KMS, 2 = KMST, 3 = JMS, 4 = CMS, 6 = TMS, 7 = MSEA, 8 = GlobalMS, 5 = Test Server
...
//        mplew.writeLong(ServerConstants.number3);
    ...
    public static final byte[] getSecondSuccessRequest(final MapleClient client) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//        final String worldName = LoginServer.getTrueServerName();
        ...
        mplew.writeShort(100); // 經驗百分比
        mplew.writeShort(100); // 掉寶百分比
        int lastChannel = 1;
...
//        mplew.writeInt(0);
    ...
    public static final byte[] getServerListNull(final int serverId) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//        mplew.writeInt(0);
    ...
    public static final byte[] getCharList(final String secondpw, final List<MapleCharacter> chars, int charslots) {
        ...
        for (final MapleCharacter chr : chars) {
            addCharEntry(mplew, chr, false/*!chr.isGM() && chr.getLevel() >= 30*/, false);
        }
        mplew.write(3);
        mplew.write(0);
