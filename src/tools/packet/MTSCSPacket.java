...
//        mplew.writeZeroBytes(2000);
        mplew.writeMapleAsciiString(c.getAccountName()); //asiasoft ID
...
//        mplew.writeZeroBytes(4);
    ...
    public static byte[] useWheel(byte charmsleft) { // 原地復活術
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
/*        } else if (vip >= 2) {
    ...
    public static byte[] getCSAccount(MapleClient c) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//        mplew.writeInt(GameConstants.GMS ? chr.getCSPoints(1) : 0); //something or NX Prepaid
    ...
    public static final void addCashItemInfo(MaplePacketLittleEndianWriter mplew, int uniqueid, int accId, int itemid, int sn, int quantity, String sender, long expire, boolean isFirst) {
        ...
        mplew.writeLong(0/*isFirst ? 0 : sn*/);
//        mplew.writeZeroBytes(10);
    ...
    public static byte[] sendCSFail(int err) {
        ...
        mplew.write(GameConstants.GMS ? 0x7D : 0x71);
        mplew.write(err);
    ...
    public static byte[] showCouponRedeemedItem(int itemid) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.writeShort(GameConstants.GMS ? 0x75 : 0x69);
        mplew.writeInt(0);
        mplew.writeInt(1);
        mplew.writeShort(1);
    ...
    public static byte[] showCouponRedeemedItem(Map<Integer, Item> items, int mesos, int maplePoints, MapleClient c) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(GameConstants.GMS ? 0x75 : 0x69); //use to be 4c
...
/*        List<Pair<Item, String>> mcii = c.getPlayer().getCashInventory().loadGifts();
        mplew.writeShort(mcii.size());
        for (Pair<Item, String> mcz : mcii) {
...
//        mplew.writeShort(4); //00 00 04 00 <-- added?
    ...
    public static byte[] sendWishList(MapleCharacter chr, boolean update) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write((update ? 0x2F : 0x2B)/*(update ? 0x22 : 0x20)*/); //+12
    ...
    public static byte[] sendGift(int price, int itemid, int quantity, String receiver) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x38); // 0x38 0x5B 0x5F 0x65都可以
...
//        mplew.writeInt(price);
    ...
    public static byte[] increasedInvSlots(MapleInventoryType type/*int inv*/, int slots) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x3A/*GameConstants.GMS ? 0x78 : 0x6C*/);
        mplew.write(type.getType()/*inv*/);
    ...
    public static byte[] increasedStorageSlots(int slots) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x3C/*GameConstants.GMS ? 0x7A : 0x6E*/);
        mplew.writeShort(slots);
    ...
    public static byte[] confirmFromCSInventory(Item item, short pos) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x3E/*GameConstants.GMS ? 0x80 : 0x74*/);
...
//	mplew.writeInt(0);
    ...
    public static byte[] confirmToCSInventory(Item item, int accId, int sn) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x40/*GameConstants.GMS ? 0x82 : 0x76*/);
    ...
    public static byte[] cashItemExpired(int uniqueid) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x42/*GameConstants.GMS ? 0x86 : 0x78*/); //use to be 5d
        mplew.writeLong(uniqueid);
        return mplew.getPacket();
    }
    ...
    public static byte[] showBoughtCSPackage(Map<Integer, Item> ccc, int accid) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x5D/*GameConstants.GMS ? 0xA3 : 0x97*/); //use to be 7a
...
/*        if (ccc.size() > 0) {
    ...
    public static byte[] showBoughtCSQuestItem(int price, short quantity, byte position, int itemid) {
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x61/*GameConstants.GMS ? 0xA7 : 0x9B*/);
        mplew.writeInt(price);
        mplew.writeShort(quantity);
