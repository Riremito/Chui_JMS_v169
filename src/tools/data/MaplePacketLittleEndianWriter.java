...
public class MaplePacketLittleEndianWriter {
    ...
    private static final Charset ASCII = Charset.forName("Shift_JIS"); // US-ASCII, ISO-8859-1, UTF-8, MS949
...
/*        if (ServerConstants.ShowSendP) {
    ...
    public final void writeTime(Long tTime) {
