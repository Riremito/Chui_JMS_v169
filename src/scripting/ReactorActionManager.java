    ...
    public void dropItems(boolean meso, int mesoChance, int minMeso, int maxMeso, int minItems) {
        ...
        for (final ReactorDropEntry d : items) {
            if (d.itemId == 0) {
                ...
                reactor.getMap().spawnReactorMesoDrop(mesoDrop, dropPos, reactor, getPlayer(), false, (byte) 0, delay);
            } else {
                Item drop;
                ...
                reactor.getMap().spawnReactorItemDrop(reactor, getPlayer(), drop, dropPos, false, false, delay);
            }
            dropPos.x += 25;
            delay += 250;
        }
