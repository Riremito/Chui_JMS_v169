...
public abstract class AbstractPlayerInteraction {
    ...
    public final void warp(final int map, final int portal) {
        ...
        if (portal != 0 && map == c.getPlayer().getMapId()) { //test
            ...
            if (portalPos.distanceSq(getPlayer().getTruePosition()) < 90000.0) { //estimation
                c.announce(MaplePacketCreator.instantMapWarp((byte) portal)); //until we get packet for far movement, this will do
    ...
    public final void warp(final int map, String portal) {
        ...
        if (map == c.getPlayer().getMapId()) { //test
            ...
            if (portalPos.distanceSq(getPlayer().getTruePosition()) < 90000.0) { //estimation
                c.getPlayer().checkFollow();
                c.announce(MaplePacketCreator.instantMapWarp((byte) c.getPlayer().getMap().getPortal(portal).getId()));
    ...
    public final void playPortalSE() {
        c.announce(MaplePacketCreator.showOwnBuffEffect(0, 7, 1, 1));
    }
    ...
    public final void showQuestMsg(final String msg) {
        c.announce(MaplePacketCreator.showQuestMsg(msg));
    }
    ...
    public final void gainItem(final int id, final short quantity, final boolean randomStats, final long period, final int slots, final String owner, final MapleClient cg) {
        ...
        cg.announce(MaplePacketCreator.getShowItemGain(id, quantity, true));
    }
    ...
    public final void GuildPQNotice() {
        getGuild().broadcast(MaplePacketCreator.GuildPQNotice(getChannel(), 1));
//        World.Guild.guildPacket(getPlayer().getGuildId(), packet);
    }

/*    public final void guildPacket(final byte[] packet) {
        World.Guild.guildPacket(getPlayer().getGuildId(), packet);
    }*/
    ...
    public final void givePartyItems(final int id, final short quantity, final List<MapleCharacter> party) {
        for (MapleCharacter chr : party) {
            ...
            chr.getClient().announce(MaplePacketCreator.getShowItemGain(id, quantity, true));
        }
    }
    ...
    public final void removeFromParty(final int id, final List<MapleCharacter> party) {
        for (final MapleCharacter chr : party) {
            ...
            if (possesed > 0) {
                ...
                chr.getClient().announce(MaplePacketCreator.getShowItemGain(id, (short) -possesed, true));
            }
        }
    }
    ...
    public final void useItem(final int id) {
        ...
        c.announce(UIPacket.getStatusMsg(id));
    }
    ...
    public final int getChannel() {
        return c.getPlayer().getClient().getChannel();
    }
    ...
    public final int getMonsterCount(final int mapid) {
        return c.getChannelServer().getMapFactory().getMap(mapid).getMobsSize()/*getNumMonsters()*/;
    }
    ...
    public final void dojo_getUp() {
        c.announce(MaplePacketCreator.updateInfoQuest(1207, "pt=1;min=4;belt=1;tuto=1")); //todo
        c.announce(MaplePacketCreator.Mulung_DojoUp2());
        c.announce(MaplePacketCreator.instantMapWarp((byte) 6));
    }
    ...
    public final void Aran_Start() {
        c.announce(UIPacket.Aran_Start());
    }

    public final void evanTutorial(final String data, final int v1) {
        c.announce(MaplePacketCreator.getEvanTutorial(data));
    }

    public final void AranTutInstructionalBubble(final String data) {
        c.announce(UIPacket.AranTutInstructionalBalloon(data));
    }
    ...
    public final void showWZEffect(final String data) {
        c.announce(UIPacket.ShowWZEffect(data));
    }

    public final void EarnTitleMsg(final String data) {
        c.announce(UIPacket.EarnTitleMsg(data));
    }
    ...
    public void showMapEffect(String path) {
        getClient().announce(UIPacket.MapEff(path));
    }
...
//	FileoutputUtil.log(FileoutputUtil.PQ_Log, text);
    ...
    public void trembleEffect(int type, int delay) {
        c.announce(MaplePacketCreator.trembleEffect(type, delay));
    }
    ...
    public void ShipPacket(final int effect, final int effect2) {
        c.announce(MaplePacketCreator.boatPacket(effect, effect2));
    }
}
