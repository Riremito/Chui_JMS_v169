...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public void askMapSelection(final String sel) {
        ...
        c.announce(MaplePacketCreator.getMapSelection(id, sel));
    ...
    public void sendNext(String text, int id) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "00 01", (byte) 0));
        lastMsg = 0;
    }
    ...
    public void sendNextS(String text, byte type, int idd) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "00 01", type, idd));
        lastMsg = 0;
    }
    ...
    public void sendPrev(String text, int id) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "01 00", (byte) 0));
        lastMsg = 0;
    }
    ...
    public void sendPrevS(String text, byte type, int idd) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "01 00", type, idd));
        lastMsg = 0;
    }
    ...
    public void sendNextPrev(String text, int id) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "01 01", (byte) 0));
        lastMsg = 0;
    }
    ...
    public void sendNextPrevS(String text, byte type, int idd) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "01 01", type, idd));
        lastMsg = 0;
    }
    ...
    public void sendOk(String text, int id) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "00 00", (byte) 0));
        lastMsg = 0;
    }
    ...
    public void sendOkS(String text, byte type, int idd) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 0, text, "00 00", type, idd));
        lastMsg = 0;
    }
    ...
    public void sendYesNo(String text) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 1, text, "", (byte) 0));
        lastMsg = 1;
    }
    ...
    public void sendYesNoS(String text, byte type, int idd) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 1, text, "", type, idd));
        lastMsg = 1;
    }
    ...
    public void askAcceptDecline(String text, int id) {
        ...
        lastMsg = (byte) 0x0C;
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) lastMsg, text, "", (byte) 0));
    }
    ...
    public void askAcceptDeclineNoESC(String text, int id) {
        ...
        lastMsg = (byte) 0x0C;
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) lastMsg, text, "", (byte) 1));
    }
    ...
    public void askAvatar(String text, int... args) {
        ...
        c.announce(MaplePacketCreator.getNPCTalkStyle(id, text, args));
        lastMsg = 9;
    }
    ...
    public void sendSimple(String text, int id) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 4, text, "", (byte) 0));
        lastMsg = 4;
    }
    ...
    public void sendSimpleS(String text, byte type, int idd) {
        ...
        c.announce(MaplePacketCreator.getNPCTalk(id, (byte) 4, text, "", (byte) type, idd));
        lastMsg = 4;
    }
    ...
    public void sendStyle(String text, int styles[]) {
        ...
        c.announce(MaplePacketCreator.getNPCTalkStyle(id, text, styles));
        lastMsg = 9;
    }
    ...
    public void sendGetNumber(String text, int def, int min, int max) {
        ...
        c.announce(MaplePacketCreator.getNPCTalkNum(id, text, def, min, max));
        lastMsg = 4;
    }
    ...
    public void sendGetText(String text, int id) {
        ...
        c.announce(MaplePacketCreator.getNPCTalkText(id, text));
        lastMsg = 3;
    }
    ...
    public void playSound(boolean broadcast, String sound) {
        if (broadcast) {
            ...
            c.announce(MaplePacketCreator.playSound(sound));
        }
    }
    ...
    public void environmentChange(boolean broadcast, String env) {
        if (broadcast) {
            ...
            c.announce(MaplePacketCreator.environmentChange(env, 2));
        }
    }
    ...
    public void genericGuildMessage(int code) {
        c.announce(MaplePacketCreator.genericGuildMessage((byte) code));
    }
    ...
    public void displayGuildRanks() {
        c.announce(MaplePacketCreator.showGuildRanks(id, MapleGuildRanking.getInstance().getRank()));
    }
    ...
    public void openDuey() {
        ...
        c.announce(MaplePacketCreator.sendDuey((byte) 9, null));
    }
    ...
    public void sendPVPWindow() {
        c.announce(MaplePacketCreator.sendPVPWindow(0));
        c.announce(MaplePacketCreator.sendPVPMaps());
    }

    public void sendRepairWindow() {
        c.announce(MaplePacketCreator.sendRepairWindow(id));
    }

    public void sendProfessionWindow() {
        c.announce(MaplePacketCreator.sendProfessionWindow(0));
    }
    ...
    public void maxStats() {
        ...
        c.announce(MaplePacketCreator.updatePlayerStats(statup, c.getPlayer().getJob()));
    }
    ...
    public void putKey(int key, int type, int action) {
        ...
        getClient().announce(MaplePacketCreator.getKeymap(getPlayer().getKeyLayout()));
    }
    ...
    public void sendPendant(boolean b) {
        c.announce(MaplePacketCreator.pendantSlot(b));
    }
