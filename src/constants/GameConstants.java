...
public class GameConstants {
	...
	18384706, 19392187, 20454878, 21575805, 22758159, 24005306, 25320796, 26708375, 28171993, 29715818,//121等到這
        ...
        155332142, 163844343, 172823012, 182293713, 192283408, 202820538, 213935103, 225658746, 238024845, 251068606,// 161等
        264827165, 279339693, 294647508, 310794191, 327825712, 345790561, 364739883, 384727628, 405810702, 428049128,// 171等
        451506220, 476248760, 502347192, 529875818, 558913012, 589541445, 621848316, 655925603, 691870326, 729784819, // 181等
        769777027, 811960808, 856456260, 903390063, 952895838, 1005114529, 1060194805, 1118293480, 1179575962, 1244216724, // 191等
    ...
    public static final int[] cashBlock = {5190000, 5190001, 5190002, 5190003, 5190004, 5190005, 5190000, 5191000, 5191001, 5191002, 5191003
    , 5191004, 5200000, 5200001, 5200002, 5201000, 5201001, 5201002, 5210000, 5210001, 5210002, 5210003, 5210004, 5210005, 5210015, 5210016
    , 5210017, 5210018, 5210019, 5210020, 5210021, 5211000, 5211001, 5211002, 5230000, 5030000, 5030001, 5030002, 5030003, 5030004, 5030005
    , 5050000, 5040000, 5040001, 5041000, 5121000, 5121001, 5121002, 5121003, 5121004, 5121005, 5121006, 5121007, 5121008, 5121009, 5121010
    , 5121011, 5121012, 5121013, 5220000, 5221000, 5340000, 5340001, 5350000, 5360000, 5360001, 5360002, 5360003, 5360004, 5360005, 5320000
    , 5130000 // 護身符
    };
    public static final int JAIL = 180000002, MAX_BUFFSTAT = 4, MAX_MOB_BUFFSTAT = 1;
    public static final int[] blockedSkills = {4341003};
    public static final String[] RESERVED = {"Rental", "Donor"};
    public static final String[] stats = {"tuc", "reqLevel", "reqJob", "reqSTR", "reqDEX", "reqINT", "reqLUK", "reqPOP", "cash", "cursed", "success", "setItemID", "equipTradeBlock", "durability", "randOption", "randStat", "masterLevel", "reqSkillLevel", "elemDefault", "incRMAS", "incRMAF", "incRMAI", "incRMAL", "canLevel", "skill", "charmEXP", "recoveryHP", "recoveryMP"};
...
/*    public static boolean isApplicableSkill_(int skil) { //not applicable to saving but is more of temporary
    ...
    public static boolean isMovementAffectingBuff(MapleBuffStat stat) {
        switch (stat) {
            case SPEED:
            case JUMP:
            case SLOW:
    ...
    public static boolean isMovementAffectingDeBuff(MapleDisease stat) {
        switch (stat) {
            case SLOW:
            case STUN:
            case WEAKEN:
...
//            case 103000800: //kerning PQ crocs
    ...
    public static double 地圖怪物倍率(int mapid) {
        switch (mapid) {
            case 100040000:
                return 2;
            case 101010101:
...
/*    public static int MaxRegular(int mapid, int spawnSize) {
        switch (mapid) {
            case 50000:
                return spawnSize;
            case 101010100:
