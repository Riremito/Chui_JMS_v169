...
/*    public void update(MapleClient c) {
        c.announce(MaplePacketCreator.arrangeStorage(slots, items, true));
    }*/

    public void sendStored(MapleClient c, MapleInventoryType type) {
        c.announce(MaplePacketCreator.storeStorage(slots, type, /*items*/typeItems.get(type)));
    }

    public void sendTakenOut(MapleClient c, MapleInventoryType type) {
        c.announce(MaplePacketCreator.takeOutStorage(slots, type, /*items*/typeItems.get(type)));
    }
