        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            case shammos_Fenter: {
                if (c.getPlayer().getMapId() >= (GameConstants.GMS ? 921120100 : 921120005) && c.getPlayer().getMapId() < (GameConstants.GMS ? 921120300 : 921120500)) {
                    ...
                    c.announce(MaplePacketCreator.getNodeProperties(shammos, c.getPlayer().getMap()));
    ...
    public static void startScript_User(final MapleClient c, String scriptName) {
        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            case cannon_tuto_direction1: {
                ...
                c.announce(UIPacket.ShowWZEffect("Effect/Direction4.img/cannonshooter/face04"));
                c.announce(UIPacket.ShowWZEffect("Effect/Direction4.img/cannonshooter/out01"));
            ...
            case q31103s:
                ...
                break;
            case Resi_tutor20:
                c.announce(UIPacket.MapEff("resistance/tutorialGuide"));
                break;
            case Resi_tutor30:
                c.announce(UIPacket.AranTutInstructionalBalloon("Effect/OnUserEff.img/guideEffect/resistanceTutorial/userTalk"));
                break;
            case Resi_tutor40:
                NPCScriptManager.getInstance().dispose(c);
                c.removeClickedNPC();
            ...
            case mPark_stageEff:
                ...
                switch ((c.getPlayer().getMapId() % 1000) / 100) {
                    ...
                    case 2:
                    case 3:
                        c.announce(UIPacket.MapEff("monsterPark/stageEff/stage"));
                        c.announce(UIPacket.MapEff("monsterPark/stageEff/number/" + (((c.getPlayer().getMapId() % 1000) / 100) + 1)));
                        break;
                    case 4:
                        if (c.getPlayer().getMapId() / 1000000 == 952) {
                            c.announce(UIPacket.MapEff("monsterPark/stageEff/final"));
                        } else {
                            c.announce(UIPacket.MapEff("monsterPark/stageEff/stage"));
                            c.announce(UIPacket.MapEff("monsterPark/stageEff/number/5"));
                        }
                        break;
                    case 5:
                        c.announce(UIPacket.MapEff("monsterPark/stageEff/final"));
            ...
            case TD_MC_title: {
                ...
                c.announce(UIPacket.IntroLock(false));
                c.announce(MaplePacketCreator.enableActions());
                c.announce(UIPacket.MapEff("temaD/enter/mushCatle"));
                break;
            }
            case TD_NC_title: {
                switch ((c.getPlayer().getMapId() / 100) % 10) {
                    case 0:
                        c.announce(UIPacket.MapEff("temaD/enter/teraForest"));
                        break;
                    case 1:
                    case 2:
                    case 3:
                    ...
                    case 5:
                    case 6:
                        c.announce(UIPacket.MapEff("temaD/enter/neoCity" + ((c.getPlayer().getMapId() / 100) % 10)));
                        break;
                }
                break;
            }
...
//                        c.getPlayer().dropMessage(-1, "勲章 - " + String.valueOf(m) + "探険家 currently in progress");
                        c.announce(MaplePacketCreator.showQuestMsg("勲章 - " + String.valueOf(m) + "探険家挑戦中。" + number + "/" + m.maps.length + " 完了"));
                    }
                }
                break;
            }
            ...
            case iceCave: {
                ...
                c.announce(UIPacket.ShowWZEffect("Effect/Direction1.img/aranTutorial/ClickLirin"));
                c.announce(UIPacket.IntroDisableUI(false));
                c.announce(UIPacket.IntroLock(false));
                c.announce(MaplePacketCreator.enableActions());
                break;
            ...
            case rienArrow: {
                if (c.getPlayer().getInfoQuest(21019).equals("miss=o;helper=clear")) {
                    ...
                    c.announce(UIPacket.AranTutInstructionalBalloon("Effect/OnUserEff.img/guideEffect/aranTutorial/tutorialArrow3"));
                }
                break;
            }
            case rien: {
            ...
            case Massacre_result: { //clear, give exp, etc.
                ...
                //} else {
                //	c.announce(MaplePacketCreator.showEffect("killing/clear"));
                //}
    ...
    private static void sendDojoStart(MapleClient c, int stage) {
        c.announce(MaplePacketCreator.environmentChange("Dojang/start", 4));
        c.announce(MaplePacketCreator.environmentChange("dojang/start/stage", 3));
        c.announce(MaplePacketCreator.environmentChange("dojang/start/number/" + stage, 3));
