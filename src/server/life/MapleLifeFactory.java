...
/*        if (questCount.size() > 0) {
    ...
    public static MapleMonsterStats getMonsterStats(int mid) {
		...
		return null;
            ...
            stats.setDefaultHp(/*GameConstants.getPartyPlayHP(mid) > 0 ? GameConstants.getPartyPlayHP(mid) : */MapleDataTool.getIntConvert("maxHP", monsterInfoData));
            stats.setMp(MapleDataTool.getIntConvert("maxMP", monsterInfoData, 0));
            stats.setDefaultExp(mid == 9300027 ? 0 : (/*GameConstants.getPartyPlayEXP(mid) > 0 ? GameConstants.getPartyPlayEXP(mid) : */MapleDataTool.getIntConvert("exp", monsterInfoData, 0)));
