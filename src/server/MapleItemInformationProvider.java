...
public class MapleItemInformationProvider {
	...
	public void runItems() {
		...
		System.out.println(dataCache.size() + " 個道具已載入");
	}
	...
	public final int getRecoveryHP(final int itemId) {
		if (getEquipStats(itemId) == null || !getEquipStats(itemId).containsKey("recoveryHP")) {
			return 0;
		}
		return getEquipStats(itemId).get("recoveryHP");
	}

	public final int getRecoveryMP(final int itemId) {
		if (getEquipStats(itemId) == null || !getEquipStats(itemId).containsKey("recoveryMP")) {
			return 0;
		}
		return getEquipStats(itemId).get("recoveryMP");
	}
